...
public class Ink {
    ...
    while (!valid) {
      ...
      System.out.println(
          "  " + ANSI_BLUE + "~~~~~~~~~~~~~~~~~~~~~~~~~~~~" + ANSI_RESET + "\n" +
              ...
              + "   |" + ANSI_RESET + "\n" +
              "  " + ANSI_BLUE + "|            " + ANSI_RESET + ANSI_CYAN + "(4) Exit" + ANSI_RESET + ANSI_BLUE
              + "             |" + ANSI_RESET + "\n" +
              "  " + ANSI_BLUE + "~~~~~~~~~~~~~~~~~~~~~~~~~~~~" + ANSI_RESET);
      try {
        ...
        if (choice >= 1 && choice <= 4) {
          ...
          System.out.println(ANSI_RED + "Please enter a number between 1 and 4." + ANSI_RESET);
        }
      } catch (Exception e) {
  ...
  public void bookAppointment(User user) {
    try {
      ...
      System.out.println(ANSI_GREEN + "Congratulations!!! Your appointment is booked for " + getDayOfWeek(day) + ANSI_RESET);
    } catch (Exception e) {
